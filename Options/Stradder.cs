...
namespace Straddle
{
    public partial class Stradder : Form
    {
        ...
        public Stradder()
        {
            InitializeComponent();
            KeyPreview = true;
            KeyPress += new KeyPressEventHandler(Stradder_KeyPress);
        }

        void Stradder_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Escape)
            {
                AppGlobal._Stradder = null;
                Close();
            }
        }

        private void Stradder_Load(object sender, EventArgs e)
        {
        ...
        private void Stradder_FormClosing(object sender, FormClosingEventArgs e)
        {
            AppGlobal._Stradder = null;
        }
