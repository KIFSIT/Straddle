...
namespace Straddle
{
    public partial class LSL_Strangle : Form
    {
        ...
        public LSL_Strangle()
        {
            ...
            KeyPress += new KeyPressEventHandler(LSL_Strangle_KeyPress);
        }

        void LSL_Strangle_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void LSL_Strangle_Load(object sender, EventArgs e)
        {
        ...
        private void LSL_Strangle_FormClosing(object sender, FormClosingEventArgs e)
        {
            AppGlobal._LSL_Strangle = null;
        }
        ...
        private void addRule1_Click(object sender, EventArgs e)
        {
            ...
            foreach (var watchT in AppGlobal.MarketWatch.Where(x => (x.Leg1.ContractInfo.TokenNo == Convert.ToString(TokenNo))))
            {
                ...
                {
                    if (watchT.StrategyId == 32211 && watchT.Strategy == StrategyName)
                    {
            ...
            AppGlobal.LSL_Strangle = AppGlobal.LSL_Strangle + 1;
            ...
            for (int i = 0; i < AppGlobal.MarketWatch.Count; i++)
            {
                ...
                if (_strategy_No > strategy_No)
                {
                    ...
                    watch.SeqaureOff = 1;
                    watch.StrategyId = 32211;
                    watch.TLI_StrategyId = 32211;
                    watch.StrategyName = "LSL_Strangle";
                    ...
                    watch.Over = 0;
                    watch.Round = 0;
                    watch.LSL_UniqueId = AppGlobal.LSL_Strangle;
