...
namespace Straddle
{
    public partial class TLI_CE_Calender : Form
    {
        ...
        public TLI_CE_Calender()
        {
            InitializeComponent();
            this.KeyPreview = true;
            KeyPress += new KeyPressEventHandler(TLI_Calender_KeyPress);
        }

        void TLI_Calender_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Escape)
            {
                AppGlobal._TLI_Calender = null;
                Close();
            }
        }

        private void TLI_Calender_Load(object sender, EventArgs e)
        {
        ...
        private void TLI_Calender_FormClosing(object sender, FormClosingEventArgs e)
        {
            AppGlobal._TLI_Calender = null;
        }

        private void cmbExpiry2_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void addRule1_Click(object sender, EventArgs e)
        {
            ...
            foreach (var watchT in AppGlobal.MarketWatch.Where(x => (x.Leg1.ContractInfo.TokenNo == Convert.ToString(TokenNo))))
            {
                ...
                {
                    if (watchT.StrategyId == 1113 && watchT.Strategy == StrategyName)
                    {
            ...
            for (int i = 0; i < AppGlobal.MarketWatch.Count; i++)
            {
                ...
                if (_strategy_No > strategy_No)
                {
                    ...
                    watch.SeqaureOff = 1;
                    watch.StrategyId = 1113;
                    watch.TLI_StrategyId = 1113;
                    watch.StrategyName = "TLI_CE_Calender";
            ...
            TransactionWatch.ErrorMessage("StrangleStrike2 |" + cmbSymbol2.Text.ToString() + "|" + cmbStrike2.Text.ToString() + "|" + cmbExpiry2.Text.ToString() + "|" + "CE");
        }
