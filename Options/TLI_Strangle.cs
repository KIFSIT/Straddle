...
namespace Straddle
{
    public partial class TLI_Strangle : Form
    {
        #region Variable
        string[] threeExpiry;
        ...
        public TLI_Strangle()
        {
            ...
            KeyPress += new KeyPressEventHandler(TLI_Strangle_KeyPress);
        }

        void TLI_Strangle_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Escape)
            {
                AppGlobal._TLI_Strangle = null;
                Close();
            }
        }

        private void TLI_Strangle_Load(object sender, EventArgs e)
        {
        ...
        private void TLI_Strangle_FormClosing(object sender, FormClosingEventArgs e)
        {
            AppGlobal._TLI_Strangle = null;
        }
        ...
        private void addRule1_Click(object sender, EventArgs e)
        {
            ...
            string nL2 = n1.Substring(0, 4);
            string nL3 = n1.Substring(4, 3);
            string nL4 = n1.Substring(7, 2);
            ...
            foreach (var watchT in AppGlobal.MarketWatch.Where(x => (x.Leg1.ContractInfo.TokenNo == Convert.ToString(TokenNo))))
            {
                ...
                {
                    if (watchT.StrategyId == 12211 && watchT.Strategy == StrategyName)
                    {
            ...
            for (int i = 0; i < AppGlobal.MarketWatch.Count; i++)
            {
                ...
                if (_strategy_No > strategy_No)
                {
                    ...
                    watch.SeqaureOff = 1;
                    watch.StrategyId = 12211;
                    watch.TLI_StrategyId = 12211;
                    watch.StrategyName = "TLI_Strangle";
            ...
            TransactionWatch.ErrorMessage("StrangleStrike1 |" + cmbSymbol1.Text.ToString() + "|" + cmbStrike1.Text.ToString() + "|" + cmbExpiry1.Text.ToString() + "|" + "CE");
            ...
            if (NextStrategy2)
            {
                ...
                watch.SL_BuyOrderflg = false;
                //DataGridViewButtonCell ToggleButtonBuy = new DataGridViewButtonCell();
                //if (watch.SL_BuyOrderflg)
                //{
                //    ToggleButtonBuy.Value = "ON";
                //    ToggleButtonBuy.Style.ForeColor = Color.Green;
                //}
                //else
                //{
                //    ToggleButtonBuy.Value = "OFF";
                //    ToggleButtonBuy.Style.ForeColor = Color.Red;
                //}

                //ToggleButtonBuy.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
                //AppGlobal.frmWatch.dgvMarketWatch.Rows[selectindex].Cells[WatchConst.SL_BuyOrder] = ToggleButtonBuy;

                watch.SL_SellOrderflg = false;
                //DataGridViewButtonCell ToggleButtonSell = new DataGridViewButtonCell();
                //if (watch.SL_SellOrderflg)
                //{
                //    ToggleButtonSell.Value = "ON";
                //    ToggleButtonSell.Style.ForeColor = Color.Green;
                //}
                //else
                //{
                //    ToggleButtonSell.Value = "OFF";
                //    ToggleButtonSell.Style.ForeColor = Color.Red;
                //}
                //ToggleButtonSell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
                //AppGlobal.frmWatch.dgvMarketWatch.Rows[selectindex].Cells[WatchConst.SL_SellOrder] = ToggleButtonSell;
