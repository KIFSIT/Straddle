...
using ArisDev.NseCmApi.Header;
using ArisDev.NseCmApi.OrderAndTradeManagement;
using ArisDev;

namespace ArisDev.NseCmApi
{
    namespace Header
    {
    ...
    namespace OrderAndTradeManagement
    {
        ...
        internal class OrderEntryRequest
        {
            ...
            {
                get { return ArisApi.DoubleTwiddling(_execTimeStamp); }
                set { _execTimeStamp = ArisApi.DoubleTwiddling(value); }
            }
            #endregion
    ...
    namespace Broadcast
    {
        ...
        public struct InteractiveMBOData
        {
            ...
            /// 
            /// </summary>
            public double BbTotalBuyQuantity { get { return ArisApi.DoubleBitReverse(_bbTotalBuyQuantity); } }
            /// <summary>
            /// 
            /// </summary>
            public double BbTotalSellQuantity { get { return ArisApi.DoubleBitReverse(_bbTotalSellQuantity); } }
            /// <summary>
            /// 
            /// </summary>
